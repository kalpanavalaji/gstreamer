...
gst_buffer_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_BUFFER_FLAG_TAG_MEMORY), "GST_BUFFER_FLAG_TAG_MEMORY", "tag-memory" },
    { C_FLAGS(GST_BUFFER_FLAG_SYNC_AFTER), "GST_BUFFER_FLAG_SYNC_AFTER", "sync-after" },
...
gst_clock_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_CLOCK_FLAG_NEEDS_STARTUP_SYNC), "GST_CLOCK_FLAG_NEEDS_STARTUP_SYNC", "needs-startup-sync" },
...
gst_debug_graph_details_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_DEBUG_GRAPH_SHOW_FULL_PARAMS), "GST_DEBUG_GRAPH_SHOW_FULL_PARAMS", "full-params" },
    { C_FLAGS(GST_DEBUG_GRAPH_SHOW_ALL), "GST_DEBUG_GRAPH_SHOW_ALL", "all" },
    { C_FLAGS(GST_DEBUG_GRAPH_SHOW_VERBOSE), "GST_DEBUG_GRAPH_SHOW_VERBOSE", "verbose" },
    { 0, NULL, NULL }
  };
...
gst_message_type_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_MESSAGE_DEVICE_ADDED), "GST_MESSAGE_DEVICE_ADDED", "device-added" },
    { C_FLAGS(GST_MESSAGE_DEVICE_REMOVED), "GST_MESSAGE_DEVICE_REMOVED", "device-removed" },
...
gst_pad_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_PAD_FLAG_ACCEPT_TEMPLATE), "GST_PAD_FLAG_ACCEPT_TEMPLATE", "accept-template" },
...
gst_plugin_dependency_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_PLUGIN_DEPENDENCY_FLAG_FILE_NAME_IS_PREFIX), "GST_PLUGIN_DEPENDENCY_FLAG_FILE_NAME_IS_PREFIX", "file-name-is-prefix" },
    { 0, NULL, NULL }
  };
...
gst_seek_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_SEEK_FLAG_TRICKMODE_KEY_UNITS), "GST_SEEK_FLAG_TRICKMODE_KEY_UNITS", "trickmode-key-units" },
    { C_FLAGS(GST_SEEK_FLAG_TRICKMODE_NO_AUDIO), "GST_SEEK_FLAG_TRICKMODE_NO_AUDIO", "trickmode-no-audio" },
    { 0, NULL, NULL }
  };
...
gst_segment_flags_get_type (void)
{
  ...
  static const GFlagsValue values[] = {
    ...
    { C_FLAGS(GST_SEGMENT_FLAG_TRICKMODE), "GST_SEGMENT_FLAG_TRICKMODE", "trickmode" },
    ...
    { C_FLAGS(GST_SEGMENT_FLAG_TRICKMODE_KEY_UNITS), "GST_SEGMENT_FLAG_TRICKMODE_KEY_UNITS", "trickmode-key-units" },
    { C_FLAGS(GST_SEGMENT_FLAG_TRICKMODE_NO_AUDIO), "GST_SEGMENT_FLAG_TRICKMODE_NO_AUDIO", "trickmode-no-audio" },
    { 0, NULL, NULL }
  };
...
gst_tracer_value_scope_get_type (void)
{
  static gsize id = 0;
  static const GEnumValue values[] = {
    { C_ENUM(GST_TRACER_VALUE_SCOPE_PROCESS), "GST_TRACER_VALUE_SCOPE_PROCESS", "process" },
    { C_ENUM(GST_TRACER_VALUE_SCOPE_THREAD), "GST_TRACER_VALUE_SCOPE_THREAD", "thread" },
    { C_ENUM(GST_TRACER_VALUE_SCOPE_ELEMENT), "GST_TRACER_VALUE_SCOPE_ELEMENT", "element" },
...
gst_tracer_value_flags_get_type (void)
{
  static gsize id = 0;
  static const GFlagsValue values[] = {
    { C_FLAGS(GST_TRACER_VALUE_FLAGS_NONE), "GST_TRACER_VALUE_FLAGS_NONE", "none" },
    { C_FLAGS(GST_TRACER_VALUE_FLAGS_OPTIONAL), "GST_TRACER_VALUE_FLAGS_OPTIONAL", "optional" },
    { C_FLAGS(GST_TRACER_VALUE_FLAGS_AGGREGATED), "GST_TRACER_VALUE_FLAGS_AGGREGATED", "aggregated" },
    { 0, NULL, NULL }
  };
...
gst_parse_error_get_type (void)
{
  ...
  static const GEnumValue values[] = {
    ...
    { C_ENUM(GST_PARSE_ERROR_DELAYED_LINK), "GST_PARSE_ERROR_DELAYED_LINK", "delayed-link" },
    { 0, NULL, NULL }
  };
